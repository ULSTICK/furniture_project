...
public class ModBlock {
    ...
    public static final RegistryObject<Block> OAK_SHELF = Furniture.registerBlock("oak_shelf", () -> new ShelfBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).harvestTool(ToolType.AXE).strength(3.0F).sound(SoundType.WOOD).noOcclusion()));
